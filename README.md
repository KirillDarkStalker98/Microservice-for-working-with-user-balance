...
* Если скрипты создания таблиц не сработали, нужно зайти в консоль контейнера базы данных, выбрать базу "service_db", и прямо в консоль вставить SQL код из файла "bd.sql", после того как код был вставлен наша база готова к работе с сервисом в Docker (Пользователь postgres и пароль в .env файле).
...
├── docker-compose.yml - Файл для конфигурации и запуска сервисов в Docker
